...
/**
* This class does the work of Loading the Data and building Node to Node
 * paths. 
 * @author VMittal
*
*/
public class BaggageHandlerMaster {
                ...
                */
                ...
                /**
                * This Field contains the initial connection List.After the complete
                * node to node list is populated in newCollectionLink this is merged
                 * into collectionLink.
                */
                Map<BaggageConnection,BaggageConnection> collectionLink = new HashMap<>();
               
                /**
                * This field contains the Node->Node path which was created based on Config data.
                */
                ...
                */
                ...
                public void loadBaggageProperties()
                                throws IOException
                {
               
                                Properties prop = new Properties();
                                InputStream input = getClass().getClassLoader().getResourceAsStream(BaggageHandlerConstant.PROPERTIES_FILE_NAME);
                ...
                public void loadConfigData()
                                throws InCorrectFileException,IOException,FileNotFoundException
                {
                ...
                public List<String[]> loadBaggageInfo()
                ...
                */
                public void loadDepartureData(List<String[]> departureFileData )
                ...
                /**
                * This method builds the initial bidirectional transit List.
                * This is used further to derive all the Hops from One Node to Another.
                 * @param conveyorFileData
                */
               
                public void buildInitialTransitList(List<String[]> conveyorFileData)
                                throws InCorrectFileException
                {
                        ...
                        BaggageConnection bgConnection = new BaggageConnection(firstNode,secondNode,Integer.parseInt(rowData[2]));
                                ...
                                BaggageConnection bgConnection1 = new BaggageConnection(secondNode , firstNode,Integer.parseInt(rowData[2]));
                ...
                /**
                * This is method which runs through the initial list of build the
                 * Node -> Node path.
                * @return
                */
                BaggageNode buildBaggageLink()
                {
                                                ...
                                                {
                                                                System.out.println("Input"+gbConn);
                ...
                void checkForLinks(BaggageConnection inputConnection  )
                {
                                for(BaggageConnection innerConn:collectionLink.keySet())
                                {
                                                ...
                                                if(!inputConnection.getEndNode().getNodeNumber().equals(innerConn.getStartNode().getNodeNumber()))
                                                                continue;
                                                if(inputConnection.getEndNode().equals(innerConn.getStartNode())&&!inputConnection.getIntermediateNodes().contains(innerConn.getEndNode()))
                                                {
                                                                //Create new Node.
                                                                BaggageConnection newConnection = new BaggageConnection(inputConnection.getStartNode(),innerConn.getEndNode(),inputConnection.getTotalTransitTime()+innerConn.getTotalTransitTime());
                                                                List<BaggageNode> copy = (List<BaggageNode>) ((LinkedList<BaggageNode>)inputConnection.getIntermediateNodes()).clone();
